...
from PyQt6.QtWidgets import QWidget, QListWidgetItem, QVBoxLayout, QHBoxLayout
...
class BubbleMessage(QtWidgets.QWidget):
    def __init__(self, str_content, avatar_path, Type, is_send=False, parent=None):
        super().__init__(parent)
        self.isSend = is_send
...
class Chat_Window(FramelessWindow):
    ...
    def setupUi(self, Form):
        ...
        self.file = TransparentToolButton(QIcon("D:\\Icon\\file.ico"), parent=Form)
        ...
        self.sight_chat = TransparentToolButton(QIcon(r"D:\Icon\Video_chat.ico"), parent=Form)
